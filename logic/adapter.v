...
output        o_kbd_SPI_CS_n;
output        o_kbd_SPI_Clk;
output        o_kbd_SPI_MOSI;
output        o_mouse_SPI_CS_n;
output        o_mouse_SPI_Clk;
output        o_mouse_SPI_MOSI;
...
defparam pll_inst.CLKFB_HIGH      = 8'd119;
defparam pll_inst.CLKFB_LOW       = 8'd119;
...
defparam pll_inst.CLKOUT0_HIGH    = 8'd2;
defparam pll_inst.CLKOUT0_LOW     = 8'd2;
...
defparam pll_inst.CLKOUT1_HIGH    = 8'd7;
defparam pll_inst.CLKOUT1_LOW     = 8'd7;
...
defparam pll_inst.CLKOUT3_HIGH    = 8'd11;
defparam pll_inst.CLKOUT3_LOW     = 8'd11;
...
defparam pll_inst.VCO_POST_DIV    = 1'b0;
`else
altpll pll_inst (
  .areset(!PLL_ENABLE),
...
defparam pll_inst.clk0_multiply_by        = 240;
defparam pll_inst.clk0_phase_shift        = "0";
defparam pll_inst.clk1_divide_by          = 32;
defparam pll_inst.clk1_multiply_by        = 240;
defparam pll_inst.clk1_phase_shift        = "0";
defparam pll_inst.clk2_divide_by          = 12;
defparam pll_inst.clk2_multiply_by        = 240;
defparam pll_inst.clk2_phase_shift        = "0";
defparam pll_inst.clk3_divide_by          = 48;
defparam pll_inst.clk3_multiply_by        = 240;
defparam pll_inst.clk3_phase_shift        = "0";
defparam pll_inst.clk4_divide_by          = 12;
defparam pll_inst.clk4_multiply_by        = 240;
...
defparam pll_inst.port_clk1               = "PORT_USED";
...
`ifdef ALTA_SYN
alta_gclkgen \PLL_CLKOUT[1]_gclkgen (
  .clkin(PLL_CLKOUT[1]),
  .ena(1'b1),
  .clkout(usb0_xcvr_clk_gclkgen)
);
alta_io_gclk \usb0_xcvr_clk_gclk (
  .inclk(usb0_xcvr_clk_gclkgen),
  .outclk(usb0_xcvr_clk)
);
`else
cycloneive_clkctrl #(
...
analog_ip macro_inst(
  .LED                (LED                ),
  .i_kbd_CH374_INT_n  (i_kbd_CH374_INT_n  ),
  .i_kbd_SPI_MISO     (i_kbd_SPI_MISO     ),
  .i_mouse_CH374_INT_n(i_mouse_CH374_INT_n),
  .i_mouse_SPI_MISO   (i_mouse_SPI_MISO   ),
  .o_kbd_SPI_CS_n     (o_kbd_SPI_CS_n     ),
  .o_kbd_SPI_Clk      (o_kbd_SPI_Clk      ),
  .o_kbd_SPI_MOSI     (o_kbd_SPI_MOSI     ),
  .o_mouse_SPI_CS_n   (o_mouse_SPI_CS_n   ),
  .o_mouse_SPI_Clk    (o_mouse_SPI_Clk    ),
  .o_mouse_SPI_MOSI   (o_mouse_SPI_MOSI   ),
  .sys_clock          (sys_gck            ),
  .bus_clock          (bus_clk            ),
  .resetn             (sys_resetn         ),
  .stop               (sys_ctrl_stop      ),
